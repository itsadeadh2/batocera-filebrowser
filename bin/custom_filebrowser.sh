#!/usr/bin/env bash
#
#           CUSTOM File Browser Installer Script for BATOCERA
#   Based on the original installation of: https://raw.githubusercontent.com/filebrowser/get/master/get.sh
#

# This script will install filebrowser to the /userdata/system/bin folder and add it to PATH
install_filemanager()
{
